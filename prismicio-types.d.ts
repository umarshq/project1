...
type NewProjectsDocumentDataSlicesSlice = never;

/**
 * Content for New Projects documents
 */
interface NewProjectsDocumentData {
  /**
   * Slice Zone field in *New Projects*
   *
   * - **Field Type**: Slice Zone
   * - **Placeholder**: *None*
   * - **API ID Path**: new_projects.slices[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#slices
   */
  slices: prismic.SliceZone<NewProjectsDocumentDataSlicesSlice> /**
   * Meta Title field in *New Projects*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A title of the page used for social media and search engines
   * - **API ID Path**: new_projects.meta_title
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */;
  meta_title: prismic.KeyTextField;
  ...
  /**
   * Meta Description field in *New Projects*
   *
   * - **Field Type**: Text
   * - **Placeholder**: A brief summary of the page
   * - **API ID Path**: new_projects.meta_description
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  meta_description: prismic.KeyTextField;
  ...
  /**
   * Meta Image field in *New Projects*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: new_projects.meta_image
   * - **Tab**: SEO & Metadata
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  meta_image: prismic.ImageField<never>;
...
/**
 * New Projects document from Prismic
 *
 * - **API ID**: `new_projects`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/custom-types
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type NewProjectsDocument<Lang extends string = string> =
  prismic.PrismicDocumentWithUID<
    Simplify<NewProjectsDocumentData>,
    "new_projects",
    Lang
  >;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      NewProjectsDocument,
      NewProjectsDocumentData,
      NewProjectsDocumentDataSlicesSlice,
      PageDocument,
      PageDocumentData,
